...
@Component(
	immediate = true,
	property = {
		"filter.init.auth.verifier.PortalSessionAuthVerifier.urls.includes=/dynamic-data-mapping-data-provider-instances/*",
		...
		"osgi.http.whiteboard.filter.pattern=/dynamic-data-mapping-data-provider-instances/*"
	},
	service = Filter.class
)
public class DDMDataProviderInstancesAuthVerifierFilter
