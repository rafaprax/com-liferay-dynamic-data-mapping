...
@Component(
	immediate = true,
	property = {
		"filter.init.auth.verifier.PortalSessionAuthVerifier.urls.includes=/dynamic-data-mapping-data-form-functions/*",
		...
		"osgi.http.whiteboard.filter.pattern=/dynamic-data-mapping-data-form-functions/*"
	},
