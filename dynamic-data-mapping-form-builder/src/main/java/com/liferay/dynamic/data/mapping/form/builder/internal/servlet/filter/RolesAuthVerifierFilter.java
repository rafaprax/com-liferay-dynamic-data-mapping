...
@Component(
	immediate = true,
	property = {
		"filter.init.auth.verifier.PortalSessionAuthVerifier.urls.includes=/dynamic-data-mapping-roles/*",
		...
		"osgi.http.whiteboard.filter.pattern=/dynamic-data-mapping-roles/*"
	},
