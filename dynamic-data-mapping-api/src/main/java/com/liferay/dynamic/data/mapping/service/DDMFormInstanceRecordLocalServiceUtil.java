 ...
 * {@link com.liferay.dynamic.data.mapping.service.impl.DDMFormInstanceRecordLocalServiceImpl} and is the
 ...
 * @see com.liferay.dynamic.data.mapping.service.base.DDMFormInstanceRecordLocalServiceBaseImpl
...
public class DDMFormInstanceRecordLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.dynamic.data.mapping.service.impl.DDMFormInstanceRecordLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord addDDMFormInstanceRecord(
	...
	*/
	public static com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord createDDMFormInstanceRecord(
	...
	*/
	public static com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord deleteDDMFormInstanceRecord(
		com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord ddmFormInstanceRecord) {
	...
	*/
	...
	public static com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord fetchDDMFormInstanceRecord(
		long formInstanceRecordId) {
	...
	*/
	...
	public static com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord fetchFormInstanceRecord(
	...
	* @throws PortalException if a ddm form instance record with the primary key could not be found
	*/
	public static com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord getDDMFormInstanceRecord(
		long formInstanceRecordId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord> getDDMFormInstanceRecords(
		int start, int end) {
	...
	*/
	...
	public static java.util.List<com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord> getFormInstanceRecords(
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord> orderByComparator) {
		return getService()
				   .getFormInstanceRecords(ddmFormInstanceId, userId, start,
			end, orderByComparator);
	}
	...
	public static int getFormInstanceRecordsCount(long ddmFormInstanceId,
		int status) {
		return getService()
				   .getFormInstanceRecordsCount(ddmFormInstanceId, status);
	}

	public static int getFormInstanceRecordsCount(long ddmFormInstanceId,
		long userId) {
		return getService()
				   .getFormInstanceRecordsCount(ddmFormInstanceId, userId);
	}

	public static com.liferay.dynamic.data.mapping.storage.DDMFormValues getFormValues(
		long ddmStorageId)
		throws com.liferay.dynamic.data.mapping.exception.StorageException {
		return getService().getFormValues(ddmStorageId);
	}
	...
	*/
	...
	public static void revertFormInstanceRecord(long userId,
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		getService()
			.revertFormInstanceRecord(userId, ddmFormInstanceRecordId, version,
			serviceContext);
	}
	...
	*/
	public static com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord updateDDMFormInstanceRecord(
		com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord ddmFormInstanceRecord) {
	...
	public static com.liferay.dynamic.data.mapping.model.DDMFormInstanceRecord updateFormInstanceRecord(
		...
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService()
				   .updateFormInstanceRecord(userId, ddmFormInstanceRecordId,
	...
	private static ServiceTracker<DDMFormInstanceRecordLocalService, DDMFormInstanceRecordLocalService> _serviceTracker =
		ServiceTrackerFactory.open(DDMFormInstanceRecordLocalService.class);
}