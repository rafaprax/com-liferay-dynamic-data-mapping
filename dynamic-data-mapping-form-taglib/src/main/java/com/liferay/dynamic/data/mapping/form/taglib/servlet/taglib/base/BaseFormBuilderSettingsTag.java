 ...
 * @generated
 */
public abstract class BaseFormBuilderSettingsTag extends com.liferay.taglib.util.IncludeTag {
	...
	protected void setAttributes(HttpServletRequest request) {
		request.setAttribute("liferay-form:form-builder-settings:portletNamespace", _portletNamespace);
		request.setAttribute("liferay-form:form-builder-settings:ddmForm", _ddmForm);
	}

	protected static final String _ATTRIBUTE_NAMESPACE = "liferay-form:form-builder-settings:";

	private static final String _END_PAGE =
		"/form_builder_settings/end.jsp";

	private static final String _START_PAGE =
		"/form_builder_settings/start.jsp";
